...
<div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" id="empno" type="text"
						   name="classAll.postTransfer.empno" value="${param.empno}"   readonly>
				</div>
			</div>
                <div class="form-group">
				...
				<div class="col-sm-10">
					<input class="form-control" id="oldPno" type="text"
						   name="classAll.postTransfer.oldPno" value="${param.oldPno}"   readonly>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<select class="form-control" id="newPno" name="classAll.postTransfer.newPno" 
							placeholder="请选择岗位名称">
